...
http://antosreadlineforhardy.alexanderweb.de/
libreadline5_5.2-3build1pypy_i386.deb
...
class DefaultConfig:
    ...
    # WARNING: for this option to work properly, you need to patch readline
    # with this:
...
class Completer(rlcompleter.Completer, ConfigurableClass):
    ...
    def color_for_obj(self, i, name, value):
        ...
        # hack hack hack
        # prepend a fake escape sequence, so that readline can sort the matches
        # correctly
...
def has_leopard_libedit():
    ...
    if not err and 'libedit' in out.decode():
        return True
