...
COLORS: dict[str, dict[str, Colors]] = {
    ...
    "light": {  # light, warm
        ...
        "yellow":         (( 76, 100,  66), ( 41, 100,  42), "#D59200"),
        ...
        "bright_red":     (( 29,  80,  50), (  6,  54,  50), "#C5473A"),
        "bright_orange":  (( 53,  90,  60), ( 27,  76,  48), "#D8711D"),
        "bright_yellow":  (( 76, 100,  70), ( 41, 100,  44), "#E39B00"),
        "bright_green":   ((129,  90,  55), ( 83,  62,  36), "#689423"),
        "bright_cyan":    ((201,  85,  55), (183,  64,  37), "#22959C"),
        "bright_blue":    ((254,  70,  50), (212,  53,  49), "#3C79C0"),
        "bright_purple":  ((322,  70,  50), (292,  41,  50), "#A54BB4"),
        "bright_magenta": ((  8,  70,  50), (345,  49,  51), "#C04665"),
        "dim_red":        (( 29,  45,  85), (  9,  51,  85), "#ECCCC7"),
        "dim_orange":     (( 53,  45,  85), ( 23,  55,  83), "#ECCEBC"),
        "dim_yellow":     (( 76,  45,  85), ( 35,  54,  80), "#E8D1B1"),
